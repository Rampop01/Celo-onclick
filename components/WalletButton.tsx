    ...
    return (
      ...
      >
        <motion.button
          ...
          className="w-full max-w-xs sm:w-auto px-4 py-3 bg-linear-to-r from-blue-500 to-cyan-500 text-white rounded-full font-semibold text-base flex items-center justify-center space-x-2 hover:shadow-lg transition-shadow"
        >
